          ...
          <div className="sm:flex sm:flex-col lg:flex-row justify-between items-center">
            ...
            <div className="shrink-0">
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4 mb-12 md:mb-0">
                <div>
                  <a className="btn-sm w-full inline-flex items-center text-blue-50 bg-blue-500 hover:bg-blue-600 group shadow-xs" href="/apply">
                    Join the waitlist
                ...
                {/*<div>
                  <a
                    className="btn-sm w-full inline-flex items-center text-white bg-slate-700 hover:bg-slate-800 shadow-xs relative before:absolute before:inset-0 before:bg-blue-400/60 before:-z-10 before:rounded-full"
                    href="#0"
                  >
                    Get in touch
                  </a>
